...
while True:
    ...
    if(Flaga_posrednia==False):
        if((time.time()-timer) < 5):
            ...
            if(Main_flaga==False):
                if((object_to_follow.xcenter!=imH / 2) and (object_to_follow.ycenter != imW / 2) and (object_to_follow.xmin != 0) and (object_to_follow.xmax != imW) and (object_to_follow.ymin!=0) and  (object_to_follow.ymax!=imH) ): 
