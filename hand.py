              ...
              for handLandmarks in results.multi_hand_landmarks:
                  ...
                  for point in handsModule.HandLandmark:
                    ...
                    #   Using the Finger Joint Identification Image we know that point 8 represents the tip of the Index Finger
                      if point == 8 and count== 0:
                         #  print(point)
                         #  print(pixelCoordinatesLandmark[0])
                         # print(normalizedLandmark)
                          cv2.rectangle(frame1,(pixelCoordinatesLandmark[0]-3,pixelCoordinatesLandmark[1]-3),(pixelCoordinatesLandmark[0]+3,pixelCoordinatesLandmark[1]+3),(255,0,0),5)
                          
                      
                      if point == 8 and count== 1:
                          cv2.rectangle(frame1,(pixelCoordinatesLandmark[0]-3,pixelCoordinatesLandmark[1]-3),(pixelCoordinatesLandmark[0]+3,pixelCoordinatesLandmark[1]+3),(0,255,0),5)
